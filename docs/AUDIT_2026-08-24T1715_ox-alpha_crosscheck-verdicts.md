...
*Cross-check generated by ox-alpha, 2026-08-24T17:15. Every verdict in §2-§7 was re-derived from direct source inspection during this pass; toolchain gates (build/lint/vitest) re-run at snapshot `b1dba65`.*
