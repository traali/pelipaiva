...
> = {
  ...
  'ruukinlahti': { name: 'Ruukinlahden tekonurmi', lat: 60.16197, lng: 24.86975, isIndoor: false, surface: 'artificial_turf_3g', hasFloodlights: true },
  'ruukinlahti tn': { name: 'Ruukinlahden tekonurmi', lat: 60.16197, lng: 24.86975, isIndoor: false, surface: 'artificial_turf_3g', hasFloodlights: true },
  'ruukinlahti nap tn': { name: 'Ruukinlahden tekonurmi', lat: 60.16197, lng: 24.86975, isIndoor: false, surface: 'artificial_turf_3g', hasFloodlights: true },
  'ruukinlahden tekonurmi': { name: 'Ruukinlahden tekonurmi', lat: 60.16197, lng: 24.86975, isIndoor: false, surface: 'artificial_turf_3g', hasFloodlights: true },
  'ruukinlahden tn': { name: 'Ruukinlahden tekonurmi', lat: 60.16197, lng: 24.86975, isIndoor: false, surface: 'artificial_turf_3g', hasFloodlights: true },
  'ruukinlahden': { name: 'Ruukinlahden tekonurmi', lat: 60.16197, lng: 24.86975, isIndoor: false, surface: 'artificial_turf_3g', hasFloodlights: true },
  'ruukinlahdentie': { name: 'Ruukinlahden tekonurmi', lat: 60.16197, lng: 24.86975, isIndoor: false, surface: 'artificial_turf_3g', hasFloodlights: true },
  'ruukinlahdentie 3': { name: 'Ruukinlahdentie 3', lat: 60.16190, lng: 24.86950, isIndoor: false, surface: 'artificial_turf_3g', hasFloodlights: true },
  'lauttasaarentie 51': { name: 'Ruukinlahden tekonurmi', lat: 60.16197, lng: 24.86975, isIndoor: false, surface: 'artificial_turf_3g', hasFloodlights: true },
  ...
  'otaniemen lukio': { name: 'Otaniemen lukio', lat: 60.1865, lng: 24.8285, isIndoor: true, surface: 'indoor_parquet', hasFloodlights: true },
  'otaniemi lukio': { name: 'Otaniemen lukio', lat: 60.1865, lng: 24.8285, isIndoor: true, surface: 'indoor_parquet', hasFloodlights: true },
  'tapiolan lukio': { name: 'Tapiolan lukio', lat: 60.1770, lng: 24.8050, isIndoor: true, surface: 'indoor_parquet', hasFloodlights: true },
  'pohjois tapiolan lukio': { name: 'Pohjois-Tapiolan lukio', lat: 60.1860, lng: 24.7950, isIndoor: true, surface: 'indoor_parquet', hasFloodlights: true },
  'haukilahti lukio': { name: 'Haukilahden lukio', lat: 60.1600, lng: 24.7700, isIndoor: true, surface: 'indoor_parquet', hasFloodlights: true },
  'leppävaaran lukio': { name: 'Leppävaaran lukio', lat: 60.2210, lng: 24.8140, isIndoor: true, surface: 'indoor_parquet', hasFloodlights: true },
  'matinkylän lukio': { name: 'Matinkylän lukio', lat: 60.1590, lng: 24.7520, isIndoor: true, surface: 'indoor_parquet', hasFloodlights: true },
  'espoonlahden lukio': { name: 'Espoonlahden lukio', lat: 60.1490, lng: 24.6560, isIndoor: true, surface: 'indoor_parquet', hasFloodlights: true },
...
export async function resolveSportsVenue(
  ...
  if (typeof fetch !== 'undefined' && rawVenueString) {
    ...
    try {
      const helUrl = `https://api.hel.fi/servicemap/v2/search/?q=${encodeURIComponent(rawVenueString)}&type=unit`;
      const pRes = await fetch(helUrl, { signal: AbortSignal.timeout(5000) });
      if (pRes.ok) {
